...
import { Brain, Sparkles, Loader2, MapPin, Calendar } from 'lucide-react';
        ...
        <form
          ...
          onSubmit={async (event) => {
            ...
            try {
              ...
              setRecommendations([]);
              setError(apiError.response?.data?.message || 'Could not generate recommendations right now.');
            } finally {
              setLoading(false);
            }
          }}
          ...
          {loading ? (
            ...
            recommendations.map((event) => (
              ...
              >
                ...
                {event.ai_reason && (
                  <p style={{ marginTop: '6px', color: 'var(--text-muted)', fontSize: '0.78rem' }}>{event.ai_reason}</p>
                )}
              </a>
            ))
          ) : (
